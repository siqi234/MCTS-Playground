...
class DecisionNode:
    def __init__(self, state, parent=None):
        ...
        # For better explanation, added success and failure counts to track how many times this node led to a win or a loss in the simulations
        self.success = 0
        self.failure = 0
