...
if __name__ == "__main__":
    # Setup environment
    env = gym.make('FrozenLake-v1', is_slippery=True, render_mode="human") # is_slippery=True for stochastic problems
    ...
    while not done:
        ...
        visualize_mcts_tree(tree_root, filename=f"frozen-lake/slippry_tree/mcts_step_{step_count}")
    ...
    with open("frozen-lake/slippry_tree/slippery_run_history.json", "w") as f:
